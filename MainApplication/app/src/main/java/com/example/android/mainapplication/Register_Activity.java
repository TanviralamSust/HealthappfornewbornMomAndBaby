...
public class Register_Activity extends AppCompatActivity implements HttpListener {
    ...
    private void initClickListeners() {
        findViewById(R.id.register).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String user = emailField.getText().toString();
                ...
                else
                {
                    ...
                    emailField.setText(user+" is this correct ?");
                    confDialog.findViewById(R.id.ok).setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            HttpRequest request = new HttpRequest(urls.domainAddress+""+"?"+"tag=register"+"&user="+user+"&pass="+pass,REQUEST_EMAIL_VALIDATION,Register_Activity.this);
    ...
    public void respond(String jsonRespond, int respondId, HttpRequest parent) {
        ...
        try {
            ...
            if(isValidEmail.equals("registration successful"))
            {
