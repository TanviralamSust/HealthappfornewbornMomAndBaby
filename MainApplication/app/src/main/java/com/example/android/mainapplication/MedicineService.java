            ...
            public void run() {
                while (true) {
                    try {
                        ...
                        if(alarm!=null){
                            Log.i("nihal99"," insevice = = "+alarm);
                            Log.i("nihal99"," current time = = "+time);
                            Log.i("nihal99"," time slice = = "+alarm.getTimegap());
                            notifyMed();
                        ...
                        Log.i("nihalnew"," insevice size new= "+alarms.size());
                        Log.i("my seted alarms",""+alarms.size());
                        for(int i= 0;i<=alarms.size();i++){
                            Log.i("nihal1"," insevice = "+alarms);
                        }
                        realm.close();
