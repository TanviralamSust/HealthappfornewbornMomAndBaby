...
public class New_Medicine extends AppCompatActivity {
    ...
    public static long startmillis,endmillis;
    public static long milliTymGap = 60*1000;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        editTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.i("tanvir1","time gap ="+ milliTymGap);
            }
        });
    ...
    private TimePickerDialog.OnTimeSetListener mTimeSetListener =
            new TimePickerDialog.OnTimeSetListener() {
                ...
                public void onTimeSet(TimePicker view, int hourOfDay, int min) {
                    ...
                    Log.i("tanvir1"," startdbefore ="+ startDate);
                    Log.i("tanvir1"," starttbefore ="+ startTime);
                    String toParse = startDate + " " + startTime;
                    SimpleDateFormat startFormatter = new SimpleDateFormat("d-M-yyyy hh:mm");
                    Date startdate = null; // You will need try/catch around this
                    try {
                        Log.i("tanvir1"," startd ="+ startDate);
                        Log.i("tanvir1"," startt ="+ startTime);
                        startdate = startFormatter.parse(toParse);
                        Log.i("tanvir1","start tym and date ="+ startdate);
                    } catch (ParseException e) {
                        e.printStackTrace();
                    }
                     startmillis = startdate.getTime();
                    Log.i("tanvir1"," convertin'g start= "+ startmillis);
    ...
    private TimePickerDialog.OnTimeSetListener mEndTimeSetListener =
            new TimePickerDialog.OnTimeSetListener() {
                ...
                public void onTimeSet(TimePicker view, int hourOfDay, int min) {
                    ...
                    Log.i("tanvir1"," endd ="+ endDate);
                    Log.i("tanvir1"," endt ="+ endTime);
                    ...
                    try {
                        Log.i("tanvir1"," enddbefore ="+ endDate);
                        Log.i("tanvir1"," endtbefore ="+ endTime);
                        enddate = endFormatter.parse(toParse);
                        Log.i("tanvir1","end tym and date ="+ enddate);
                    } catch (ParseException e) {
                        e.printStackTrace();
                    }
                    endmillis = enddate.getTime();
                    Log.i("tanvir1"," converting end="+ endmillis);
                    //Log.i("tanvy"," end" + ""+ String.valueOf(endmillis));
                }
            };
    ...
    public void viewAlaram(View view) {
        Intent intent = new Intent(New_Medicine.this,MedicineAlarmList.class);
        startActivity(intent);
    }

    public void backtomain(View view) {
        Intent intent = new Intent(New_Medicine.this,MainActivity.class);
        startActivity(intent);
    }
}
